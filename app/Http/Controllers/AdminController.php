...
class AdminController extends Controller
{
    ...
    {
        $users = DB::select(DB::raw("SELECT u.id, u.email, u.first_name, u.last_name, u.company_name, u.company_address, u.company_registration_no, u.contact, u.logo
        FROM users u, roles r, role_users i
