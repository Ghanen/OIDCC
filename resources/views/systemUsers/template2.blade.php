                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="list-group">
                                                        ...
                                                        <div class="btn btn-success" id="leftbox" ondrop="drop(event)" ondragover="allowDrop(event)">
                                                            <img src="{{ asset('images/logo/')}}/{{Sentinel::getUser()->logo}}" style="border-radius: 50%; height:50px; width:70px; float: left;">
                                                            <input type="text" class="btn btn-success" style="height:40px; width:230px; float:right;" value="Online ID Card Creation"></input>
                                                        ...
                                                        <div class="btn btn-success" id="rightbox" ondrop="drop(event)" ondragover="allowDrop(event)">
                                                            <textarea type="text" class="btn btn-success" style="" value="Online ID Card Creation"></textarea>
                                                        </div>
